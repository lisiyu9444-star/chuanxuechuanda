...
【颜色搭配原则】
- 上衣与配饰避免互补色同时大面积出现（如红配绿、蓝配橙、黄配紫）
- 若上衣为高饱和度颜色（如正红、宝蓝、亮黄），配饰应选择中性色（黑/白/米/灰/驼/裸）或与上衣同色系深浅色
- 喜用神颜色优先体现在上衣或主单品，配饰作为小面积点缀，避免全身超过3种强色
